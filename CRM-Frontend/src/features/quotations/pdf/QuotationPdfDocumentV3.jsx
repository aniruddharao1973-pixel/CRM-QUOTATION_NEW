...
const styles = StyleSheet.create({
  ...
  // Replaces sectionCard, sectionCardSoft
  sectionCard: {
    borderWidth: 1,
    borderColor: "#DBEAFE",
    borderRadius: 6,
  ...
  tableRowAlt: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: "#EFF6FF",
    backgroundColor: "#F8FAFC", // Alternating row color
  },
  tableCellHeader: {
    paddingVertical: 7,
    paddingHorizontal: 5,
  ...
  numberedTermsContent: {
    width: "93%",
    padding: 7,
  },
  numberedTermsHeading: {
    fontSize: 8.5,
    fontWeight: "bold",
    color: "#1E293B",
    marginBottom: 3,
...
const commercialTermsRows = [
  ...
  { no: "6", heading: "Transit Insurance", lines: ["Buyers account"] },
  {
    no: "7",
...
const engagementRows = [
  ...
  { no: "1.2", heading: "Software Engagement Models", lines: [] },
  {
    no: "1.3",
  ...
  return (
    <View style={styles.footer}>
      ...
      <View style={styles.footerRight}>
        <Text
          style={[styles.footerText, { textAlign: "right", marginBottom: 2 }]}
        >
...
// NEW - Visually engaging process flow component
...
function NumberedTermsTable({ title, rows }) {
  return (
    <View style={styles.numberedTermsTable}>
      <View style={styles.tableHeader}>
        <Text
          style={[
            styles.tableCellHeader,
      ...
      {rows.map((row, index) => {
        ...
        return (
          <View
            key={row.no}
            style={[
              styles.numberedTermsRow,
              { borderBottomWidth: isLast ? 0 : 1 },
            ]}
          >
            <View style={styles.numberedTermsNo}>
              <Text style={styles.numberedTermsNoText}>{row.no}</Text>
            </View>
            <View style={styles.numberedTermsContent}>
              {row.heading && (
                <Text style={styles.numberedTermsHeading}>{row.heading}</Text>
              )}
              {(row.lines || []).map((line, i) => (
                <Text key={i} style={styles.numberedTermsLine}>
                  {line}
                </Text>
              ))}
            </View>
...
export function ProposalPDF({ quotation, totals }) {
  ...
  const customerItems = [
    { label: "Customer", value: quotation?.account?.accountName || "-" },
  ...
  const pricingColumns = [
    ...
    { key: "sku", title: "SKU", width: "12%", align: "center" },
    ...
    { key: "unitPrice", title: "Unit Price", width: "10%", align: "right" },
    { key: "discount", title: "Disc %", width: "7%", align: "center" },
    { key: "gst", title: "GST", width: "7%", align: "center" },
    { key: "total", title: "Total", width: "14%", align: "right" },
  ];
  ...
  return (
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        {/* Info Card: Proposal Submitted To */}
        <View
          style={{
            borderWidth: 1,
            borderColor: "#DBEAFE",
      ...
      {[...Array(11)].map((_, i) => (
        <Page key={i + 2} size="A4" style={styles.page}>
          <PdfHeader
            ...
            date={metadata.date}
          />
          {/* Content for pages 2-12 will be dynamically inserted here */}

          {i === 0 && ( // Page 2: Revision History
            <>
              <Text
                style={{
                  fontSize: 15,
              ...
              >
                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    >
                      These are customized equipment, this proposal is
                      indicative of the concept there could be changes during
                      the detailed design which will be dealt during Design
                      Approval Process (DAP) &amp; will be subjected to the
                      customer approval.
                    </Text>
                  </View>
                </View>
          ...
          {i === 3 && ( // Page 5: Price Basis & Delivery
            <>
              ...
              />
              <SectionCard title="Price Basis & Delivery">
                <Text
                  style={{
                    fontSize: 8.8,
                    fontWeight: "bold",
          ...
          {i === 4 && ( // Page 6: Warranty
            <>
              <SectionCard title="MICROLOGIC GENERAL WARRANTY TERMS">
              ...
              <SectionCard title="Software Support Terms">
                <BulletList items={softwareSupport} />
              </SectionCard>
            </>
          )}

          {i === 5 && ( // Page 7: Engagement Model
            <>
              <Text
                style={{
                  fontSize: 15,
              ...
              <Text style={styles.centeredIntro}>
                Our engagement model is designed to ensure transparency,
          ...
          {i === 6 && ( // Page 8: Process Flow
            <>
              ...
              >
                ...
                >
                  Standard operating procedure for the successful delivery of
          ...
          {i === 8 && ( // Page 10: Commercial Terms 2 & Cancellation
            <>
              <NumberedTermsTable
                title="COMMERCIAL TERMS"
              ...
              <View style={{ marginLeft: 6, marginTop: 2, gap: 6 }}>
                {cancellationItems.map((item) => (
                  <View key={item.no} style={{ flexDirection: "row" }}>
                    <Text
                      style={{ width: 12, fontSize: 8.4, color: "#111827" }}
                    >
                      {item.no}.
                    </Text>
                    <Text
              ...
              >
                The dates of the activity will be shared in the timelines
                released by the project team.
              </Text>
              <Text
                style={{
                  fontSize: 11,
          ...
          {i === 9 && ( // Page 11: Engagement Model Definitions
            <NumberedTermsTable
            ...
            <>
              <View style={styles.tableWrap}>
                ...
                {bankTableRows.map((row, index) => {
                  const isSection = !row.no.includes(".");
                  const isLast = index === bankTableRows.length - 1;
                  return (
                    <View
                      key={index}
                      style={{
          ...
          <PdfFooter pageNumber={i + 2} totalPages={12} />
        </Page>
      ))}
    </Document>
  );
